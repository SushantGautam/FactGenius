...
class CollateFunctor:
    ...
    def __call__(self, batch):
        ...
        inputs = self.tokenizer(list(claims_with_evidence), return_tensors='pt', padding=True, truncation=True, max_length=self.max_len)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="/global/D1/projects/HOST/Datasets/factKG_ifi/simple/")
